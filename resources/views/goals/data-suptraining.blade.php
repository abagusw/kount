<div class="modal fade" id="data-suptraining" tabindex="-1" aria-labelledby="data-hrgaLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row mt-4">
                    <div class="col my-auto titleUpdate">
                        Content Quality & Relevance index average
                    </div>
                    <div class="col my-auto">
                        <div class="progress">
