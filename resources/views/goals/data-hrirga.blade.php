<div class="modal fade" id="data-hrirga" tabindex="-1" aria-labelledby="data-hrgaLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="row mt-4">
                    <div class="col my-auto titleUpdate">
                        Zero Dispute on government regulated HR matters
                    </div>
                    <div class="col my-auto">
                        <div class="progress">
                ...
                <div class="row mt-4">
                    <div class="col my-auto titleUpdate">
                        Zero mistake on payroll calculation (time&accuracy)
                    </div>
                    <div class="col my-auto">
                        <div class="progress">
                ...
                <div class="row mt-4">
                    <div class="col my-auto titleUpdate">
                        Employee Productivity average per year
                    </div>
                    <div class="col my-auto">
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" style="width: 100%; background-color: #59BECD; color: #FFC045;" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" id="prog4">100%</div>
