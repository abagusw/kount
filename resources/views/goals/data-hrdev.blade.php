<div class="modal fade" id="data-hrdev" tabindex="-1" aria-labelledby="data-hrgaLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="row mt-4">
                    <div class="col my-auto titleUpdate">
                        Manager level Recruitment SLA average
                    </div>
                    <div class="col my-auto">
                        <div class="progress">
                ...
                <div class="row mt-4">
                    <div class="col my-auto titleUpdate">
                        Program Overall Rating average
                    </div>
                    <div class="col my-auto">
                        <div class="progress">
