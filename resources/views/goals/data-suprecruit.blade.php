<div class="modal fade" id="data-suprecruit" tabindex="-1" aria-labelledby="data-hrgaLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row mt-4">
                    <div class="col my-auto titleUpdate">
                        Cost per hire average per year
                    </div>
                    <div class="col my-auto">
                        <div class="progress">
