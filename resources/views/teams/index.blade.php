                                ...
                                <div id="Page_Individual_Panel" class="panel ">
                                    <div class="row">
                                        <div class="col text-center my-auto border-right">
                                            <div class="image">
                                                <img src="{{ asset('public/img/dummy-profile.svg') }}" alt="User Image" width="200px" id="imgTeam">
                                            </div>
                                            <div class="head mt-2">
                                                <h2>Team Member 1</h2>
                                                <h5 style="color: #59BECD;"><i>Role</i></h5>
...
<script>
    ...
    function drawChart() {
        ...
        data.addRows([
            ...
            [{
                    'v': 'r1'
                    , 'f': '<div class="chart-card"><img src="{{ asset("public/img/dummy-profile.svg") }}" class="img-team"><b class="name-team">Kunthara Waluyo</b><div style="color:#6d6d6d; font-style:italic" class="role-team">HR & GA Division Head</div><button class="btn btpercent" data-toggle="modal" data-target="#data-hrga">Profile</button></div>'
                }
                , '', 'HR & GA'
            ],
            //row 2
            [{
                    'v': 'r2c1'
                    , 'f': '<div class="chart-card"><img src="{{ asset("public/img/dummy-profile.svg") }}" class="img-team"><b class="name-team">Rina Elma Suartini</b><div style="color:#6d6d6d; font-style:italic" class="role-team">HR Development Dept Head</div><button class="btn btpercent" data-toggle="modal" data-target="#data-hrdev">Profile</button></div>'
                }
                , 'r1', 'HRD'
            ]
            , [{
                    'v': 'r2c2'
                    , 'f': '<div class="chart-card"><img src="{{ asset("public/img/dummy-profile.svg") }}" class="img-team"><b class="name-team">Jumaidi Anggriawan</b><div style="color:#6d6d6d; font-style:italic" class="role-team">HR Operations & IRGA Dept Head</div><button class="btn btpercent" data-toggle="modal" data-target="#data-hrirga">Profile</button></div>'
                }
                , 'r1', 'HRO'
            ]
            , [{
